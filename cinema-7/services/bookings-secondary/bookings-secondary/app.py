...
with open("{}/cinema-7/services/bookings-secondary/bookings.json".format(examples_path), "r") as f:
...
if __name__ == "__main__":
     app.run(port=helper.get_port('bookings-secondary'), host="0.0.0.0", debug=helper.get_debug())
