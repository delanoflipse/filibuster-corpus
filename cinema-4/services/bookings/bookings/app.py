...
with open("{}/cinema-4/services/bookings/bookings.json".format(examples_path), "r") as f:
...
def booking_record(username):
    ...
    # Make call to Fandango.com to get lists of most popular movies.
    try:
        requests.head("http://www.fandango.com")
