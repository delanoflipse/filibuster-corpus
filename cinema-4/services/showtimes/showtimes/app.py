...
with open("{}/cinema-4/services/showtimes/showtimes.json".format(examples_path), "r") as f:
...
if __name__ == "__main__":
    app.run(port=helper.get_port('showtimes'), host="0.0.0.0", debug=helper.get_debug())