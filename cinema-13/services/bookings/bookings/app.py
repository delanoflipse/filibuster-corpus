...
helper = helper.Helper("cinema-13")


with open("{}/cinema-13/services/bookings/bookings.json".format(examples_path), "r") as f:
...
if __name__ == "__main__":
    app.run(port=helper.get_port('bookings'), host="0.0.0.0",
