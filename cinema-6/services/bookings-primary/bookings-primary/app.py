...
with open("{}/cinema-6/services/bookings-primary/bookings.json".format(examples_path), "r") as f:
...
if __name__ == "__main__":
     app.run(port=helper.get_port('bookings-primary'), host="0.0.0.0", debug=helper.get_debug())
