...
FilibusterRequestsInstrumentor().instrument(service_name="trending", filibuster_url=helper.get_service_url('filibuster'))

from filibuster.instrumentation.flask import FlaskInstrumentor as FilibusterFlaskInstrumentor
FilibusterFlaskInstrumentor().instrument_app(app, service_name="trending", filibuster_url=helper.get_service_url('filibuster'))
...
if __name__ == "__main__":
    app.run(port=helper.get_port("trending"), host="0.0.0.0", debug=helper.get_debug())
